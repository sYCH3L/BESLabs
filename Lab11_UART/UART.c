...
// String[0] thousands digit
// String[1] hundreds digit
// String[2] tens digit
// String[3] ones digit
// 0x20 - is space
...
void UART_ConvertUDec(unsigned long n){
	...
	if (n >= 10000) {
		...
		String[0] = (((n%10000)/1000) + 0x20 + (( ((n%10000)/1000) > 0 || 1000 < n) * 0x10));
		String[1] = (((n%1000)/100) + 0x20 + (( ((n%1000)/100) > 0 || 100 < n) * 0x10));
		String[2] = ((n%100)/10) + 0x20 + (( ((n%100)/10) > 0 || 10 < n) * 0x10);
		String[3] = ((n%10) + 0x20 + (( (n%10) > 0 || 1 < n || n == 0) * 0x10));
	}
	String[4] = 0x20;
	String[5] = 0;                 
}
